...
/**
 * Central error handling for the "Data Retrieval Error" alternative flow: errors are logged
 * server-side and a message the UI can display is returned to the caller.
 */
...
public class GlobalExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> handleValidation(MethodArgumentNotValidException ex) {
    ...
    ErrorResponse error =
        new ErrorResponse(HttpStatus.BAD_REQUEST.value(), "Invalid request", details);
