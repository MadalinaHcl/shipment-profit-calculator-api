...
/**
 * Business operations for the "Calculate Profit" use case (FR1-FR3): records income and costs for a
 * shipment, then computes and persists the resulting profit or loss.
 */
